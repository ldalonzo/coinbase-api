...
namespace LDZ.Coinbase.Api.Net.Http
{
    internal class MessageAuthenticationCodeHandler : DelegatingHandler
    {
        ...
        protected override async Task<HttpResponseMessage> SendAsync(HttpRequestMessage request, CancellationToken cancellationToken)
        {
            ...
            request.Headers.Add(HeaderNames.AccessSign, ComputeSignature(request, timeStamp));

            return await base.SendAsync(request, cancellationToken);
        }

        /// <summary>
        /// The CB-ACCESS-SIGN header is generated by creating a sha256 HMAC using the base64-decoded secret key on the prehash string
